...
class EmployeeNameWithInterface(val userId: String, val name: NameFormat, val age: Int, val occupation: Occupation)
...
fun main() {
    ...
    val employee = EmployeeNameWithInterface(userId, name, age, occupation)
